...
from pyforestplot.text_utils import form_est_ci
from pyforestplot.text_utils import normalize_varlabels
from pyforestplot.text_utils import indent_nongroupvar
from pyforestplot.text_utils import format_varlabels
from pyforestplot.text_utils import star_pval
from pyforestplot.text_utils import prep_annote
from pyforestplot.text_utils import prep_rightannnote
from pyforestplot.text_utils import make_tableheaders
from pyforestplot.dataframe_utils import insert_groups
from pyforestplot.dataframe_utils import sort_groups
from pyforestplot.dataframe_utils import sort_data
from pyforestplot.dataframe_utils import reverse_dataframe
...
def _preprocess_dataframe(
    ...
    **kwargs: Any,
    ...
    if groupvar is not None:  # Make groups
        dataframe = normalize_varlabels(dataframe=dataframe, varlabel=groupvar, capitalize=capitalize)
        dataframe = insert_groups(dataframe=dataframe, groupvar=groupvar, varlabel=varlabel)
    dataframe = normalize_varlabels(dataframe=dataframe, varlabel=varlabel, capitalize=capitalize)
...
def _make_forestplot(
    ...
    **kwargs: Any,
    ...
    draw_ref_xline(ax=ax, dataframe=dataframe, annoteheaders=annoteheaders, right_annoteheaders=right_annoteheaders, **kwargs)
    ...
    if rightannote is None:
        ...
        ax, righttext_width = draw_yticklabel2(
            dataframe=dataframe, annoteheaders=annoteheaders, right_annoteheaders=right_annoteheaders, ax=ax, **kwargs
        )
